package com.example.lanyetc.campusgo.util;

/**
 * Created by ZHANGXY on 2018/4/1.
 */
...
public class OpenAPP {
    ...
    public static  void goToNaviActivity(Context context,String sourceApplication , String poiname , String lat , String lon , String dev , String style){
        StringBuffer stringBuffer  = new StringBuffer("androidamap://navi?sourceApplication=CampusGo")
     ...
     * */
    public static void goTominimap(Context context,String currentLongitude,String currentLatitude,String destination){
        //将bd-09坐标转换成gcj-02坐标
        double[] bd09_To_Gcj02 = OpenAPP.bd09_To_Gcj02(Double.parseDouble(currentLatitude),Double.parseDouble(currentLongitude));
        ...
        try {
            if (isInstallByRead("com.autonavi.minimap")) {
                Intent intent = new Intent("android.intent.action.VIEW",
                        Uri.parse(
                                "androidamap://keywordNavi?sourceApplication=softname&keyword="+destination+"&style=2"+"&lat="+ currentLatitude//当前经度
                                        + "&lon="+ currentLongitude//当前纬度
                                        + "&dev=0"));
